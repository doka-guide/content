...
Когда сайты были проще, а [AJAX](/js/web-app-works/#клиент-серверная-архитектура) и [JSON](/tools/json/) ещё не были распространены, пагинаторы были единственным способом поделить большое количество контента на куски.
