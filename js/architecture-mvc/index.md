...
В этой статье мы приводим краткое описание паттерна MVC и его вариаций. Чтобы лучше понять разницу между ними, советуем прочесть статью «[MVC and its variants](https://herbertograca.com/2017/08/17/mvc-and-its-variants/)».
