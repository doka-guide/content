...
- Использовать знак «равно» (оператор присваивания). Если переменная хранит примитив, то данные скопируются, если переменная содержит объект то копируется только ссылка на объект.
