...
При копировании объекта внутренние данные не дублируются, а сохраняются в новом объекте как ссылки. Этот тип копирования называется _поверхностным_ (shallow).
