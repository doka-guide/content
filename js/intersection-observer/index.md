...
_delay_ — число миллисекунд, определяющее задержку срабатывания уведомлений от наблюдателя.
...
_trackVisibility_ - логическое значение, указывающее, следует ли наблюдателю отслеживать видимость целевого элемента. Если значение равно `true`, браузер будет проверять, не нарушена ли видимость целевого элемента при вычислении пересечений.
Отслеживание видимости — ресурсоемкая операция, и ее следует использовать только при необходимости. По умолчанию — false.
