...
Принцип, при котором для внесений изменений создаётся новый объект, независимый от исходного, называется **иммутабельностью (immutability)** или **неизменяемостью**.
