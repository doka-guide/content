...
Мы создали функцию `Box`, которая возвращает объект с двумя методами. Первый, `map` принимает функцию-преобразование и возвращает новый контейнер, чтобы уже к нему можно было применить следующее преобразование.
