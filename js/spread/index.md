...
☝️ При использовании спред-синтаксиса элементы массива копируются только на один уровень вложенности. Если массив содержит объекты, то это будут те же самые объекты, что и в исходном массиве. Как получить глубокую копию читайте [здесь](https://doka.guide/js/shallow-or-deep-clone/#kak-poluchit-glubokuyu-kopiyu).
