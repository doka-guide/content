...
[Код-ревью](/js/code-review) — важная часть процесса работы и гигиены кода. На ревью выявляются ошибки, дыры в безопасности и обсуждаются потенциально лучшие решения.
...
Форматтеры по сути следят за синтаксисом (точки с запятой, кавычки, табы). Для более высокоуровневых правил есть [статические анализаторы кода](/js/static-analysis/) — линтеры.
