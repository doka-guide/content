...
<aside>
  ...
  ❗ При сравнении объектов, массивов и функций, важно учесть их особенность, т. к. результат сравнения таких типов данных может быть не предсказуемым. Подружиться с особенностями можно в статье «[Хранение по ссылке и по значению](/js/ref-type-vs-value-type/)».
