...
Старайтесь анимировать свойства [`transform`](/css/doka/transform) и [`opacity`](/css/doka/opacity), чтобы сделать сайт или приложение более отзывчивыми. [Как браузер рисует страницы](/js/long/how-the-browser-creates-pages)
