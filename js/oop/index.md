...
Но в JavaScript интерфейсов нет, поэтому и полиморфизма мы достигаем таким околокостыльным способом. (К интерфейсам мы ещё вернёмся ближе к концу статьи.)
...
Писать в «труъшном» ООП-стиле на JS довольно проблематично. Хотя в JS и есть классы, у языка нет пользовательских типов и интерфейсов, а это базовая концепция абстракции и полиморфизма.
