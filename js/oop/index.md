...
Классы в JS — это синтаксический сахар над прототипным наследованием. Чтобы в деталях изучить его тонкости работы, советуем прочитать [статью о контексте выполнения в JavaScript](/js/function-context).
