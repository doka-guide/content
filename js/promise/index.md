...
<iframe title="Как ошибки ловятся в цепочках методов — Promise — Дока" src="demos/promise-catch.html"></iframe>
...
<iframe title="Название — Promise — Дока" src="demos/Lopinopulos-QWNLMwR/index.html"></iframe>
