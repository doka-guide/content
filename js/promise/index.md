...
<iframe title="Как ошибки ловятся в цепочках методов — Promise — Дока" src="demos/promise-catch/" height="350"></iframe>
...
💔 Такой код — плохой. Если в одном из последних `then` произойдёт ошибка, то вся дальнейшая цепочка не отработает, при этом, из-за асинхронной природы промиса, прочий код вне промиса продолжит работать и приложение не упадёт.
...
<iframe title="Название — Promise — Дока" src="demos/Lopinopulos-QWNLMwR/" height="300"></iframe>
