...
- есть возможность [начать выполнять действие по умолчанию не дожидаясь завершения обработчика](/js/element-addeventlistener/#uluchshenie-proizvoditelnosti-skrolla);
...
💡 Добавление обработки события на элементе сразу обоими способами также работает. Порядок выполнения обработчиков в этом случае зависит от того, какой из них был добавлен первым.
