...
💡 Элементу можно добавить сразу оба типа обработчиков одного и того же события. Порядок выполнения обрабочиков в этом случае зависит от того, какой из них был добавлен первым.
