...
💡 Если на один элемент повесить сразу оба типа обработчиков, порядок выполнения зависит от порядка добавления в коде: что раньше написано — то раньше сработает.
