...
Добавив к этому массиву ещё один элемент, чтобы его индекс был больше длины массива. Мы получили массив с незаполненным элементом (empty slot). Если обратиться к незаполненному элементу по индексу, получим `undefined`:
