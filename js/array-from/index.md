...
При создании массива происходит [поверхностное копирование (shallow copy) элементов](/js/shallow-or-deep-clone). Если объект, на основе которого создаётся массив, содержит вложенные структуры данных, то эти вложенные структуры не будут скопированы. При их изменении в объекте, изменения будут видны и в полученном массиве.
