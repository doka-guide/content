...
<iframe title="Название — for() — Дока" src="../demos/vindi-r-WWxaPV/" height="150" sandbox></iframe>
...
<iframe title="Название — for() — Дока" src="../demos/vindi-r-ROReQM/" height="300" sandbox></iframe>

🛠 Через циклы удобно вставлять данные, например в таблицы или списки:

<iframe title="Название — for() — Дока" src="../demos/vindi-r-gyMQYq/" height="150" sandbox></iframe>
...
<iframe title="Название — for() — Дока" src="../demos/vindi-r-axZQLY/" height="200" sandbox></iframe>
