...
Создадим новый массив, добавив к исходному массиву 3 элемента, начиная с элемента с индексом 1:
...
💡 Поддержка метода `toSpliced()` в основных браузерах и в Node.js появилась в 2023 году. Попытка использовать `toSpliced()` в более ранних версиях, например в Node.js v.18.19.0 приведёт к ошибке:
