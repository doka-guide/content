...
Выводит сведения о стеке вызовов для текущей функции. Информация о каждой функции будет включать имя функции и номер строки. Стек вызовов может пригодится для понимания порядка выполнения программы.
...
Прекращает группировку сообщений текущей группы (уровня). Последующие сообщения будут отображаться с отступом предыдущей группы:
