...
- `isTrusted` — указывает на происхождение события, будет в значении `true`, если событие инициировано действиями пользователя. `false` — если событие инициировано из кода с помощью [`dispatchEvent()`](/js/dispatch-event/).
