...
Может возникнуть вопрос: как механизм «поднятия» связан с темой «Области видимости»?

Благодяря «поднятию», var-переменная (со значением `undefined`) становится доступна (видна) для всего кода своей области видимости.
