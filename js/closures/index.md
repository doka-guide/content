...
Замыкание — это функция вместе со ссылкой на внешнее окружение, в котором она была создана. Замыкание возникает в момент создания функции. Возврат вложенной функции (или функций) позволяет использовать замыкание родительской функции даже после того, как её выполнение завершилось.
