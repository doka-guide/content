...
<details>
  ...
  При создании глобальных переменных с использованием `let` и `const` попадание значений в глобальном объекте `window` не предусмотрено. Это позволяет избежать конфликтов имён и улучшить безопасность.
</details>
