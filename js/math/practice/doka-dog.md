...
<iframe title="Название — Math — Дока" src="../demos/vindi-r-YMewgy/" height="80" sandbox></iframe>

🛠 Константы и математические функции чаще всего используются в рисовании или расчётах:

<iframe title="Название — Math — Дока" src="../demos/vindi-r-OGQNgz/" height="200" sandbox></iframe>
