...
В случае в клиент-серверным [Как работают веб-приложения](/js/articles/web-app-works) общением API может выступать набор ссылок, по которым клиент обращается на сервер:
...
Прочитайте статью [«Как работают веб-приложения»](/js/articles/web-app-works), чтобы глубже разобраться в клиент-серверной архитектуре.
