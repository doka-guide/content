...
Кроме него используют двунаправленный поток, например, реактивные обновления данных. Мы подробно говорим о каждом в статье [«Архитектура: потоки данных»](/js/articles/architecture-data-flow).
