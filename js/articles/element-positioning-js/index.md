...
CSS ограничен в обратной связи на действия пользователей на экране. В нём есть такие штуки как `@keyframes`, [`transition`](/css/doka/transition), [`:hover`](/css/doka/hover), [`:active`](/css/doka/active), [`:focus`](/css/focus) и т. д., но этого не всегда достаточно.
