...
С данными в домене можно работать, используя _доменные типы_. Это простые и сложные структуры данных: объекты, массивы и встроенные примитивы. В JavaScript есть механизмы для описания таких структур данных.
