...
Метод `sort()` является устойчивым, то есть элементы в массиве будут находиться в том же порядке, в каком они располагались в исходном массиве. Если два элемента равны, то первый по порядку в исходном массиве будет первым и в результирующем массиве.
