...
Метод `throw()` позволяет бросить ошибку в генератор и завершить его.
...
Если присвоить функцию-генератор в свойство `Symbol.iterator` объекта-генератора, то генератор станет многоразовым
