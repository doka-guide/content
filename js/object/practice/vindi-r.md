...
<iframe title="Название — Объект — Дока" src="../demos/vindi-r-KYXxRr/" height="150" sandbox></iframe>
...
<iframe title="Название — Объект — Дока" src="../demos/vindi-r-KYXxYE/" height="150" sandbox></iframe>

🛠 В случае, когда имя ключа неизвестно — по умному, «является динамическим», то обращаться к нему нужно через квадратные скобки:

<iframe title="Название — Объект — Дока" src="../demos/vindi-r-JVrwGg/" height="150" sandbox></iframe>
...
<iframe title="Название — Объект — Дока" src="../demos/vindi-r-yrzGqw/" height="150" sandbox></iframe>
...
<iframe title="Название — Объект — Дока" src="../demos/vindi-r-MREPZj/" height="250" sandbox></iframe>
...
<iframe title="Название — Объект — Дока" src="../demos/vindi-r-jRGJja/" height="150" sandbox></iframe>
...
<iframe title="Название — Объект — Дока" src="../demos/vindi-r-PgJvBV/" height="150" sandbox></iframe>
