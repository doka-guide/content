...
В качестве примера созданим массив с известными мандалорскими охотниками за головами. В исходной строке вместо имени героя фильма «Звёздные войны» оставим спецификатор, которые указывают на строку, передаваемую в консоль в качестве следующего параметра.
