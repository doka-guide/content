...
У кода в момент выполнения его интерпретатором есть «окружение». Это функция, которая сейчас отрабатывает, содержащиеся в ней переменные, глобальные переменные. Это все и есть **контекст**.
