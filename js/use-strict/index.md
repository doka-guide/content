...
В строгом режиме объект [`arguments`](/js/function-arguments-object/) сохраняет значения аргументов функции. Если в функции присвоить параметру новое значение, это не повлияет на объект `arguments`.
