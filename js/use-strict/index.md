...
☝️ Строгий режим не отменяет [«поднятия» (_hoisting_) var-переменных](/js/closures/#podnyatie-var-peremennyh-declaration-hoisting). Обращение к var-переменной до её объявление не вызовет ошибку:
