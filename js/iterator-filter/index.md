...
Рассмотрим ещё один пример получения чётных значений:
...
// Получаем два значения исходного итератора
...
- "Получаем первое чётное значение" — `evenIterator` выполняет callback-функцию для значений 1 и 2. Следующее доступное значение для обоих итераторов — 3.

- "Получаем два значения исходного итератора". Следующее доступное значение для обоих итераторов — 5.

- "Получаем следующее чётное значение" — `evenIterator` выполняет callback-функцию для значений 5 и 6.
