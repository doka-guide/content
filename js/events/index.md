...
<iframe title="Свойство DOM элемента onclick — События — Дока" src="demos/onclick.html" height="310"></iframe>
...
<iframe title="Метод addEventListener — События — Дока" src="demos/click.html" height="310"></iframe>
...
<iframe title="This в функции-обработчике — События — Дока" src="demos/this.html" height="230"></iframe>
...
<iframe title="Всплытие событий — События — Дока" src="demos/bubbling.html" height="460"></iframe>
...
<iframe title=">Всплытие событий по цепочке вложенности — События — Дока" src="demos/bubbling-chain.html" height="510"></iframe>
