...
Важным аспектом событийной модели является механизм _распространение событий (event propagation)_, который пределяет как события взаимодействуют с узлами DOM при достижении целевого элемента.
