...
В спецификации `EcmaScript` 2021 года (_ES12_) появилась интересная возможность - добавлять в числа разделители. Например:
...
Так же доступны для чисел других счислений и [`BigInt`](/js/bigint/):
