...
- Массив или Set-множество являются итерируемыми объектами, но не считаются итераторами, так как не содержат метода 'next()' и также не имеет доступа к методам `Iterator.prototype`.
