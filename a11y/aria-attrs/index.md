...
- `aria-multiline` (свойство) — какое количество строк можно ввести в текстовое поле.
...
- `aria-valuemax` (свойство) — максимальное значение ползунка, индикатора загрузки и других элементов с диапазоном чисел. Эквивалент в HTML — [`max`](/html/value/#meter).
- `aria-valuemin` (свойство) — минимальное значение ползунка, индикатора загрузки и других элементов с диапазоном чисел. Эквивалент в HTML — [`min`](/html/value/#meter).
