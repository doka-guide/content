...
[`aria-describedby`](/a11y/aria-describedby/) связывает с помощью одинакового ID два элемента — поле и подсказку из тега [`<span>`](/html/span/). Скринридер озвучит текст подсказки после лейбла и основной информации о поле.
...
- [`aria-labelledby`](/a11y/aria-labelledby/) (свойство) — один элемент или несколько содержат лейбл для другого элемента.
