...
Выделяют несколько видов технологий распознавания речи в зависимости от задач и устройства. Они бывают уже встроенными в операционную систему или устанавливаются отдельно.
...
Разберём основные советы, как сделать обычный интерфейс сайта более доступным для голосового управления.
...
❤️ Хороший пример: для кнопки используем `<button>`.
...
❤️ Хороший пример: поле связано с видимой подписью в `<label>`.
...
❤️ Пример получше: ссылка с коротким и более очевидным именем в ARIA-атрибуте.
...
❤️ Хороший пример: нет ничего лучше `<button>`.
...
❤️ Хороший пример: просто кнопка и ничего лишнего.
...
❤️ Хороший пример: более описательная ссылка «багеты на заказ».
...
**Дизайн**. Не будем вдаваться в ещё больше дизайнерских подробностей. Просто напомним, что стоит использовать крупные и читаемые шрифты, большие по размерам интерактивные элементы и контрастные тексты.

## Тестирование

Тестировать доступность интерфейсов для программ и приложений распознавания речи можно автоматически, вручную и с пользователями. Конечно, автоматическое тестирование не замена ручному и пользовательскому.
