...
Контекст не поможет пользователям голосового управления, когда на странице одни «тут». Не всегда так просто посчитать количество ссылок, чтобы назвать номер нужной. Показ сетки тоже отнимает время.
