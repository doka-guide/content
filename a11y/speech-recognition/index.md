...
Как можно догадаться, это всё равно не поможет полю формы найтись голосом.

**Одно имя**. На сайтах часто встречаются кнопки, поля и другие интерактивные элементы с видимым именем и `aria-label` одновременно.
...
**Всё важное — показать**. Так как голосовое управление часто используют люди, которые видят интерфейс, важное содержимое должно быть легко видно. К примеру, немодальные окна с ловушкой фокуса могут перекрыть нужные пользователям кнопки и замедлить навигацию по странице. Большое плавающее меню также скрывает под собой часть содержимого. Тултип вряд ли найдут все категории пользователей.

**Дизайн**. Не будем вдаваться в ещё больше дизайнерских подробностей. Просто напомним, что шрифт должен быть достаточно большим, интерактивные элементы — крупными, уровень контрастности — достаточным. В общем, интерфейс сайта и его содержимое должно быть видно.
