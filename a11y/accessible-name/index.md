...
Разница между именем и описанием в том, что описание более подробное и необязательное, тогда как имя напрямую влиет на доступность интерфейса для вспомогательных технологий.
...
![Схема вычисления доступного имени](images/name-calculation.png)
