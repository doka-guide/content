...
<iframe title="Пример с простой навигацией без скип-линка" src="demos/basic/" height="820"></iframe>
...
Давайте добавим скип-линк, чтобы упростить навигацию. Для этого в самое начало [`<body>`](/html/body/) перед блоком навигации добавим ссылку, которая видна только при фокусе.
...
<iframe title="Пример со скип-линком" src="demos/with-skip-link/" height="820"></iframe>
