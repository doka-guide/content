...
- [WCAG 2.2](https://www.w3.org/TR/WCAG22/). Черновик кандидата в рекомендации, станут рекомендацией во второй половине 2023.
- [WCAG 3](https://www.w3.org/TR/wcag-3.0/). Рабочий черновик, станут рекомендацией не раньше 2025.

Подробнее об истории и основных отличиях между версиями узнаете из [WCAG Version History](https://accessibleweb.com/wcag/wcag-version-history/). За обновлениями WCAG можете следить [на странице с новостями W3C](https://www.w3.org/WAI/news/).
