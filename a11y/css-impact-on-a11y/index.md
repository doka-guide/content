...
- [`visibility: hidden`](/css/visibility/) скрывает элемент и его содержимое, но оставляет его в обычном потоке страницы таким образом, что он по-прежнему занимает место.
