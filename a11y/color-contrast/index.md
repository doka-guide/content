...
проверка интерфейса с включёнными режимами дальтонизма, нечёткого зрения, пониженной или пониженной контрастности (есть в браузерах, Windows, Figma и на macOS).
...
![Информация о контрасте из отчёта Lighthouse в Chrome.](images/3.png)
