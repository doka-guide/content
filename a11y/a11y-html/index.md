...
description: "В статье собраны самые базовые рекомендации по доступной разметке: важность семантических тегов и их контента, хорошие практики для разработчиков, использование атрибутов ARIA и отладка доступности."
authors:
  - imeugenia
related:
