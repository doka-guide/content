...
Тестировать доступность можно также с помощью [Lighthouse](https://developer.chrome.com/docs/lighthouse/accessibility/scoring/) или [расширения axe](https://chrome.google.com/webstore/detail/axe/lhdoppojpmngadmnindnejefpokejbdd). Ещё один хороший инструмент с точки зрения доступности разметки — это [валидатор для HTML](https://validator.w3.org). На сайте W3C представлен полный представлен полный [список разных инструментов для тестирование и отладки доступности](https://www.w3.org/WAI/ER/tools/). 
