...
Когда нужно, чтобы пользователи узнали обо всех изменениях в логах, в том числе старых, используйте `aria-atomic="true"`. Если это срочныне изменения, добавьте `aria-live="assertive"`.
...
| `log `    | Изменения в логах. Минимальный приоритет.   | `aria-live="polite"`, `aria-atomic="false"` |
