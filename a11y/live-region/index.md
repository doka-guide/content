...
| --------  | ----------------------------------------------------------- | ---------------------- |
| `status`  | Несрочные изменения. Минимальный приоритет. | `aria-live="polite"`, `aria-atomic="true"`  |
...
| `alert`   | Срочные изменения. Максимальный приоритет. | `aria-live="assertive"`, `aria-atomic="true"`|
