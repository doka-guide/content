...
- [`button`](/a11y/role-button/) — кнопка. Эквиваленты в HTML — [`<button>`](/html/button/), [`<summary>`](/html/details/) (для некоторых скринридеров) или [`<input>` c типами](/html/input/#type) `button`, `image`, `reset`, `submit`.
...
- [`timer`](/a11y/role-timer/) — область счётчика, отсчитывающего время.
