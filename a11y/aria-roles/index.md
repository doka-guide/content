...
- `separator` — интерактивный разделитель, на котором можно сделать фокус.
...
- `separator` — обычный, неинтерактивный разделитель. Эквивалент в HTML — [`<hr>`](/html/hr/).
...
- [`mark`](/a11y/role-mark/) — выделенный или подсвеченный важный фрагмент текста. Эквивалент в HTML — [`<mark>`](/html/mark/). Из [черновика спецификации WAI-ARIA 1.3](https://w3c.github.io/aria/).
