...
- `combobox` — комбинированный список, поле со списком. Эквивалент в HTML — [`<select>`](/html/select/) без атрибута `multiple` и с `size` со значением `1`.
- `grid` — сетка.
- `listbox` — выпадающий список с несколькими опциями на выбор, в том числе с картинками. Эквиваленты в HTML — [`<datalist>`](/html/datalist/) и `<select>` с атрибутами `multiple` и `size` со значением больше 1.
...
- `progressbar` — индикатор выполнения задачи (прогресс-бар). Эквивалент в HTML — [`<progress>`](/html/progress/).
...
- `caption` — видимая подпись к таблице, сетке и похожим элементам. Эквиваленты в HTML — [`<caption>`](/html/caption/) и [`<figcaption>`](/html/figure-figcaption/).
...
- `figure` — автономное содержимое в виде изображений, иллюстраций и другой графики, у которого обычно есть подпись. Эквивалент в HTML — [`<figure>`](/html/figure-figcaption/).
...
- `listitem` — элемент списка. Эквивалент в HTML — [`<li>`](/html/li/).
...
- `term` — термин. Эквиваленты в HTML — [`<dt>`](/html/dl-dd-dt/) и [`<dfn>`](/html/dfn/).
