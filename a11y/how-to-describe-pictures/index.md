...
_Альтернативный текст_ — это краткое описание содержимого картинки. Его помещают внутрь атрибута `alt` у [`<img>`](/html/img/) или в тег [`<title>`](/html/title/) у [`<svg>`](/html/svg/). В первую очередь альтернативный текст нужен скринридерам и поисковым роботам, но, если картинка не загрузилась, его увидят и остальные пользователи.
...
Современные скринридеры постепенно учатся самостоятельно распознавать и описывать картинки без альтернативных текстов. Например, [NVDA с версии 2023.3](https://www.nvaccess.org/files/nvda/releases/2023.3/documentation/changes.html) умеет читать тексты с изображений, в JAWS появилась функция [Picture Smart AI](https://blog.freedomscientific.com/picture-smart-ai-how-we-got-here/), а под капотом у мобильного TalkBack теперь есть [Gemini Nano](https://blog.google/products/android/google-ai-android-update-io-2024/). Конечно же, искусственный интеллект упрощает жизнь пользователей скринридеров, но всё ещё не справляется с описанием картинок лучше, чем вы.
...
<iframe title="Скриншот с группой картинок" src="demos/screenshot-w-group-of-imgs/" height="1110"></iframe>
