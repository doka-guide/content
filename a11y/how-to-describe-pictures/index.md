...
Оберните эмодзи в [`<span>`](/html/span/) и добавьте к тегу `role="img"` и `aria-label="Красный флаг"`. Так все скринридеры согласятся с тем, что флаг действительно красный.
