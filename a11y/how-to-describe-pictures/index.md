...
_Альтернативный текст_ — это краткое описание содержимого картинки. Его помещают внутрь атрибута `alt` у [`<img>`](/html/img/) или в тег [`<title>`](/html/title/) у [`<svg>`](/svg/svg/). В первую очередь альтернативный текст нужен скринридерам и поисковым роботам, но, если картинка не загрузилась, его увидят и остальные пользователи.
