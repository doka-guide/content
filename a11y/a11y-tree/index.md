...
Дерево доступности состоит из _доступных объектов (accessible object)_. Каждый объект представляет один элемент интерфейса и содержит важную информацию о нём для вспомогательных технологий:
