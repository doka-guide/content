...
<iframe title="Кнопка с сообщением об успешной очистке формы" src="demos/alert-message/" height="250"></iframe>
...
🎭 Роли бывают встроенными и явно заданныами. Встроенные роли есть у большинства семантических HTML-тегов по умолчанию, а явно задать роль элементу можно как раз с помощью ARIA.
...
У всех интерактивных элементов должны быть доступные имена. Они подробнее раскрывают цель элемента. Это то, что скринридер объявляет после роли.
...
- [NVDA Bugs](https://github.com/nvaccess/nvda/issues?q=is%3Aopen+is%3Aissue+label%3Abug) — скринридер NVDA.
- [JAWS Bugs](https://github.com/FreedomScientific/VFO-standards-support/issues?q=is%3Aopen+is%3Aissue+label%3Abug/)  — скринридер JAWS.
