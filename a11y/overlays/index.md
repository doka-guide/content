...
Отдельная версия не решает проблемы пользователей, у которых несколько видов инвалидности.
