...
Единственный плюс отельных версий сайтов — возможность настроить шрифты и цвета под себя. Шрифты можно выбирать с засечками или без, разных размеров, с разными интервалами и отступами. Кроме нескольких стандартных цветовых схем есть дополнительные темы страницы.
