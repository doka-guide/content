...
Стоит учитывать пользовательские техники и инструменты при разработке доступного сайта. Тестирование со скринридерами найдёт проблемы с кодом и улучшит опыт их пользователей. Проработанный адаптивный дизайн и тестирование сайтов при увеличении на 200% помогут пользователям экранных луп. Продуманные стили для анимации с директивой [`@media`](/css/media/) и проверкой значения `prefers-reduced-motion` помогут пользователям, которые отключили анимацию в операционной системе.
