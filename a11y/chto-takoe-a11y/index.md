...
🤔 В русском языке нет точного перевода «disability». Это английском это слово означает не только медицинский диагноз и юридический статус, но и самоопределение человека, его принадлежность к определённой культуре и сообществу.

</aside>

*Барьер* — это препятствие, которое мешает человеку с инвалидностью использовать среду, продукты и услуги. Есть много типов барьеров — физические, системные, технологические, информационные и т. д. Например, наземный переход без лифта, один способ связи без альтернатив, банкоматы только с сенсорной клавиатурой или фильмы без субтитров.

Доступностью занимаются специалисты из градостроительства, дизайна устройств и одежды, транспорта и т. п.
...
На этих же принципах основан важный документ о веб-доступности — WCAG (Web Content Accessibility Guidelines, Руководства по обеспечению доступности веб-контента).
...
🎨 Этап дизайна — ключевой момент для доступности. На нём появляется 68 % от всех проблем с ней.
...
О веб-доступности есть много мифов. Вот некоторые из них:

- Если сайт стал доступным, то больше не нужно заниматься веб-доступностью.
- Сделать сайт доступным можно на последнем этапе разработки.
- Веб-доступность — это только про скринридеры.
- Оверлеи улучшают доступность сайта.
- Рекомендаций из WCAG достаточно для доступности сайта.

На самом деле веб-доступность — это постоянный процесс, как и другие подходы к разработке. Особенно это заметно на активно изменяющихся сайтах. Со временем уровень доступности снижается, поэтому за этим стоит постоянно следить.

Также заниматься веб-доступностью лучше в начале разработки. Тогда легче предусмотреть или исправить возникшие проблемы.

Веб-доступность помогает не только людям со слепотой, но и слабовидящим, людям с глухотой, тревожными расстройствами, эпилепсией, параличом и т. д. Если заниматься только доступностью для скринридеров, то такой сайт недоступен для всех остальных пользователей с инвалидностью.
...
Наконец, кроме WCAG есть ещё лучшие практики, основанные на исследованиях пользователей. К тому же, без тестирования на пользователях нельзя быть уверенным, что сайт доступный. Даже если он соответствует всем критериям WCAG.

Другие мифы найдёте в [проекте «Мифы о веб-доступности»](https://a11ymyths.com/ru/).
