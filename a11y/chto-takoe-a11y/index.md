...
Феномен, когда все люди могут пользоваться тем, что изначально создавалось только для людей с инвалидностью, называется эффектом скошенного тротуара (curb cut effect). Примеры — пандусы, скошенные тротуары, субтитры (closed captioning) и автозаполнение полей форм на сайтах.
