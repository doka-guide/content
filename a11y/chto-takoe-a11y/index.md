...
W3C WAI в начале 2023 года завершит работу над [WCAG 2.2](https://www.w3.org/TR/WCAG22/). Уже сейчас разрабатывается [WCAG 3](https://www.w3.org/TR/wcag-3.0/). Эту версию окончательно примут минимум через 4 года. Также идёт работа над двумя новыми версиями WAI-ARIA — 1.2 и 1.3. За обновлениями можно следить на [странице со списком разрабатывающихся документов W3C WAI](https://www.w3.org/WAI/update/).
