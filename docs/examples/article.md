...
related:
  - Относительная ссылка на материал по теме
tags:
  - article
---
...
8. В related добавлено три ссылки на материалы, которые будут предлагаться в конце статьи. Не добавляем следующий или предыдущий материал в разделе
-->
```
