...
Чтобы проверка не заканчивалась негативным результатом, слова-исключения нужно добавить в специальный файл _.yaspeller.json_, который лежит в корне проекта.
