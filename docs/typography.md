...
1. Комментарии в HTML пишите над комментируемой строкой. В CSS и JS — в конце комментируемой строки, если комментарий короткий, и над строкой, если комментарий средней длины, или относится к нескольким строкам сразу (в это случае можно поставить двоеточие). Если комментарий длинный — обратитесь к пункту два. Предложения в комментарии начинаются с заглавной буквы, точка в конце не ставится. Не злоупотребляйте «закрывающими» комментариями — пользуйтесь ими только в случаях сложной структуры.
