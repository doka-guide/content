...
✅ Поиск выдает: «Вы искали слово „картошка“».
...
Если нужно показать ударение в слове, используем обычный кириллический символ с комбинирующим символом ударения (combining acute accent).
