...
Если в демке нужно использовать ссылки, отдавайте препочтение пустым ссылкам `<a href="#"></a>`. Если важно, чтобы `href` не был пустым, можно использовать ссылку на главную Доки `<a href="https://doka.guide/"></a>`.
