...
В демке могут быть ссылки не только на Доку, но и на другие сайты. Мы просим ответственно отнестись к выбору ссылок для демок. Наш проект должен оставаться доступным для всех, поэтому мы не можем размещать на нём ссылки на ресурсы, которые законодательно признаны нежелательными. Редактор попросит заменить ссылку, если это необходимо.
