...
В демке могут быть ссылки не только на Доку, но и на другие сайты.

| :warning: Мы просим ответственно отнестись к выбору ссылок для демок. Наш проект должен оставаться доступным для читателей из всех стран и регионов, поэтому мы не размещаем ссылки на ресурсы, которые в этих странах и регионах признаны нежелательными или запрещены на законодательном уровне.|
| --- |

Также мы просим проверять демки с такими ссылками на работоспособность.
