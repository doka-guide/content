...
Мы просим указывать название ваших папок в `/people/` строчными буквами. Это связано с тем, что наш сервер работает на регистрозависимой операционной системе, плюс есть пользователи с Linux или macOS.
...
1. Переименовываем папку в промежуточное название: `DokaDog` -> `dokadog1` — коммитим изменение.
1. Переименовываем папку в финальное название: `dokadog1` -> `dokadog` — коммитим изменение.
