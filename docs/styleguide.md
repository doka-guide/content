...
Знаки препинания на конце не требуются, если вы приводите список ссылок. В данном случае мы рассматриваем каждую ссылку как заголовок, а на конце заголовка точка не ставится:
...
👆 Если пункты списка содержат фрагменты кода, замените такой список на текст с подзаговками.
