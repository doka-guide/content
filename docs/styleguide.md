...
Если нужно добавить в текст анимацию, отдайте предпочтение видео в формате MP4, а не гифке: видео легче и его можно поставить на паузу. Уже имеющуюся гифку можно переконвертировать из GIF в MP4 онлайн.
