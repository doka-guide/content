...
keywords:
  - флексы
<!-- предлагаемые статьи к чтению: сюда добавляем три ссылки на статьи со связанной тематикой из любого раздела. Сюда не стоит добавлять статьи, которые идут следующей или предыдущей в списке -->
related:
  - css/grid-guide
  - css/box-model
  - css/columns
