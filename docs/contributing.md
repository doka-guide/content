...
В процессе редактуры статьи редакторы или рвьюеры разделов могут предложить вам правки или доработки по статье. Все правки могут обсуждаться, не стесняйтесь высказывать своё мнение.

Ревьюер может предложить готовое исправление. В этом случае вы можете нажать кнопку <kbd>Commit suggestion</kbd> — правка будет закоммичена, файлы обновяться.
