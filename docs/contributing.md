...
1. Откройте форк в терминале и введите `./new.sh`. Ответьте на вопросы скрипта, он создаст необходимые папки и файлы и переключит ветку. Найдите созданный скриптом файл
    ...
    - Создайте новую ветку по правилам: `part/название-статьи`, где _part_ — это раздел (css, html, js или tools);
    - Создайте папку с названием статьи на английском языке в нужном разделе (html, css, js, tools).
    - Создайте в ней файл _index.md_ по шаблону: [дока](https://github.com/doka-guide/content/blob/main/docs/examples/doka.md) или [статья](https://github.com/doka-guide/content/blob/main/docs/examples/article.md).

    </details>
1. Напишите статью в новом файле (не забывайте сверяться с [руководством по стилю](https://github.com/doka-guide/content/blob/main/docs/styleguide.md)). Всё, что хорошо выглядит в маркдауне, будет хорошо выглядеть на сайте. Если вы хотите предпросматривать статью локально, почитайте [инструкцию по предпросмотру](https://github.com/doka-guide/content/blob/main/docs/preview.md).
...
1. Если вы хотите создать интерактивный пример, почитайте [инструкцию по демкам](https://github.com/doka-guide/content/blob/main/docs/demos.md).
