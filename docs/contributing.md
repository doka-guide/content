...
Если у вас есть картинка для ретина-дисплеев, добавьте файл с таким же названием и окончанием `@2x` в имени, например: `cover.png` и `cover@2x.png`. Для мобильных картинок допишите `*-mob`, например: `cover-mob.png` и `cover-mob@2x.png`
