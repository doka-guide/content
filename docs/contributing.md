...
cover:
  desktop: images/covers/desktop.png <!-- адрес широкой картинки для десктопной обложки -->
  mobile: images/covers/mobile.png <!-- адрес узкой картинки для мобильной обложки -->
...
Добавляйте картинки сразу для ретина-дисплеев, мы их преобразуем для меньших разрешений. Картинки размещаются в директории `images/covers` и называются: desktop, mobile и т.д. Обложка должна быть прозрачная. Рекомендуется использовать *.SVG-формат изображений.
