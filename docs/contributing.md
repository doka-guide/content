...
1. Форкните репозиторий.
    Если у вас уже есть форк репозитория, его не нужно удалять, воспользуйтесь командой `gh repo sync <НАЗВАНИЕ ВАШЕГО ФОРМА>`. Вам понадобится установленный [официальный CLI GitHub](https://cli.github.com).
