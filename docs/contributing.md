...
1. Форкните репозиторий.
    Если у вас уже есть форк репозитория, его не нужно удалять, воспользуйтесь командой `gh repo sync <НАЗВАНИЕ ВАШЕГО ФОРКА>`. Вам понадобится установленный [официальный CLI GitHub](https://cli.github.com).
...
1. Запустите [проверки орфографии](speller.md): `node .github/scripts/check-spelling.mjs css/ваша-статья/index.md` и `node .github/scripts/check-yo.mjs css/ваша-статья/index.md`.
