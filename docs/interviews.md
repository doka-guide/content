...
Если у вас уже есть профиль, проверьте, что название папки в директории `/people/` совпадает с названием в директории `/interviews/**/answers/`. Если видите своё имя из профиля, то всё отлично, если нет, надо проверить название папки в `/interviews/**/answers/`.
