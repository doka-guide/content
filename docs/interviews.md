...
Ваш ответ на вопрос можно подписать, для этого, воспользуйтесь [инструкцией](people.md), чтобы создать свой профиль пользователя.

Если у вас уже есть такой профиль, проверьте, что название папки в директории `/people/` совпадает с названием в директории `/interviews/**/answers/`. Если вы видите своё имя из профиля, то всё отлично, если нет, надо проверить название папки в `/interviews/**/answers/`.
