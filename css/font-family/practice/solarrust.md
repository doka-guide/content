🛠 Если в макете используется одно из нестандартных шрифтовых семейств, то вам потребуется подключить его в свою вёрстку при помощи свойства [`@font-face`](/css/font-face/).
