...
Любые не указанные значения сбрасываются до дефолтных. Хотя значения для свойств [font-size-adjust](/css/font-size-adjust) и [font-kerning](/css/font-kerning) не могут быть указаны внутри шортката `font`, но они тоже сбрасываются до дефолтных.
