...
И тут тоже всё в порядке — [`<h3>`](/html/h1-h6) по-прежнему является прямым потомком [`<article>`](/html/doka/article), потому что располагается на ближайшем уровне вложенности, хоть и следует после `div.article__header`:
