...
Псевдокласс `:required`, дополняющий основной селектор, поможет выбрать элементы [`<input>`](/html/input), [`<textarea>`](/html/doka/textarea) или [`<select>`](/html/doka/select), у которых задан атрибут `required`.
