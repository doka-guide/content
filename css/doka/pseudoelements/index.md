...
Так же псевдоэлементы приходят на помощь, когда нужно наложить поверх картинки так называемый оверлей. Но этим польза от псевдоэлементов не заканчивается.
...
<iframe title="Декоративная линия из псевдоэлемента" src="demos/greetings-gordon.html"></iframe>
...
Этот псевдоэлемент позволяет стилизовать текст, выводимый в поле ввода текста ([`input`](/html/doka/input)) в виде подсказки.
...
💡 Обязательно проверяй поддержку псевдоэлемента в нужных браузерах. Для этого можно использовать сайт [Can I use](https://caniuse.com/).
