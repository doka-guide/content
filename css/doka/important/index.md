...
Если вы работаете с проектом, в котором большая и старая кодовая база. И, предположим, у вас нет доступа к редактированию старых стилей. Вы пишите новый файл со стилями, но часть из них конфликтует с уже существующим CSS. В этой ситуации `!important` бывает незаменим.
