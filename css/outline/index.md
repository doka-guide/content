...
💡 ~~В отличие от [`border`](/css/border) обводка всегда квадратная (прямоугольная), её углы нельзя _скруглить_.~~ На сентябрь 2021 года обводка подстраивается под форму обоводимого элемента! ð Во всех актуальных версиях браузеров, кроме Safari ð
