...
- `svh` (`svw`) задаёт размер в процентах от наименьшей возможной высоты (ширины) вьюпорта. Наименьшая возможная высота (ширина) вьюпорта исключает размер элементов интерфейса пользовательского агента (например, адресной строки в мобильном браузере).
- `lvh` (`lvw`) задаёт размер в процентах от максимально возможной высоты (ширины) вьюпорта (то есть включая размер элементов интерфейса пользовательского агента).
- `dvh` (`dvw`) автоматически подстраивает высоту (ширину) в зависимости от того, отображаются или нет элементы интерфейса пользовательского агента. При наличии элементов интерфейса работает как `svh` (`svw`), при отсутствии - как `lvh` (`lvw`).
