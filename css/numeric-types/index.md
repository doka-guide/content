...
- [`vi`] тоже самое, что `vw` для языков с горизонтальным написанием. Работает так: `1vi` это 1% от размера вьюпорта в строчном направлении.
- [`vb`] как `vi`, только в блочном направлении. Для языков с горизонтальным написанием не отличается от `vh`.
