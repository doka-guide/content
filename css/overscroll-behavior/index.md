...
Значение `none` поможет в разработке одностраничных приложений (SPA). Оно отключит эффект отскока, который в мобильных браузерах может вызвать ненужную для SPA перезагрузку страницы.
