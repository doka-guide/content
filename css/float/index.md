...
<iframe title="Обтекание — float — float — Дока" src="demos/float/" height="350"></iframe>
...
<iframe title="Float до и после — float — Дока" src="demos/float-before-after/" height="350"></iframe>
...
<iframe title="Обтекание — clearfix — float — Дока" src="demos/clearfix/" height="350"></iframe>
...
<iframe title="Обтекание — flow-root — float — Дока" src="demos/flow-root/" height="350"></iframe>
