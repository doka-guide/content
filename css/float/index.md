...
<iframe title="Обтекание — float — float — Дока" src="demos/float.html" height="350"></iframe>
...
<iframe title="Float до и после — float — Дока" src="demos/float-before-after.html" height="350"></iframe>
...
<iframe title="Обтекание — clearfix — float — Дока" src="demos/clearfix.html" height="350"></iframe>
...
<iframe title="Обтекание — flow-root — float — Дока" src="demos/flow-root.html" height="350"></iframe>
