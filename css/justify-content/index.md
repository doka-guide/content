...
description: "Свойство для вырванивания элементов по основной оси в гридах и флексбоксах."
authors:
  - solarrust
editors:
  - tachisis
...
В случае, если указано свойство [`flex-direction: column`](/css/flex-direction/), то значения `left` и `right` срабатывают как `start`.

<aside>

📝 Полный список свойств флексбоксов можно посмотреть в [гайде по flexbox](/css/flexbox-guide/). А свойства гридов описаны в  [гайде по grid](/css/grid-guide/)
