...
description: "Удобный способ сохранить повторяющееся значение и потом использовать его в разных местах кода. Как переменные во взрослых языках программирования."
authors:
  - ezhkov
contributors:
  - skorobaeus
