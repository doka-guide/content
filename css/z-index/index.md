...
💡 `z-index` также срабатывает у флекс и грид-элементов и везде, где создается [контекст наложения](https://doka.guide/css/stacking-context/#kontekst-nalozheniya).
