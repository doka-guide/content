...
<iframe title="Списки по умолчанию — list-style-type — Дока" src="demos/basic/"></iframe>
...
<iframe title="Варианты list-style-type — list-style-type — Дока" src="demos/list-style-type/"></iframe>
...
<iframe title="Список без маркера — list-style-type — Дока" src="demos/ul-no-marker/"></iframe>
...
<iframe title="Список без маркера — list-style-type — Дока" src="demos/ol-no-marker/"></iframe>
...
<iframe title="Пример со свойством content — list-style-type — Дока" src="demos/empty-content/"></iframe>
...
<iframe title="Кастомные маркеры — list-style-type — Дока" src="demos/custom/"></iframe>
