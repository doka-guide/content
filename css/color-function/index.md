...
В CSS найдёте много способов [обозначения цвета](/css/web-colors/) в зависимости от нужного цветового пространства. Возможности работы с цветами изменяются, цветовых пространств становится всё больше. Пока не для каждого пространства существуют отдельные функции типа `rgb()` или `hsl()`. Некоторые цвета можно описать только при помощи `color()`.
