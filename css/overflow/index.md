...
- `clip` — новое свойство (поддерживается всеми основными браузерами, [кроме Safari](https://caniuse.com/?search=overflow%3A%20clip), похожее по результату по `hidden`, но границы родительского блока рассчитываются с учётом padding-отступов;
