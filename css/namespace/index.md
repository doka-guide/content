...
Пространство имён (`namespace`) — это механизм, который позволяет однозначно идентифицировать элементы и атрибуты. Он помогает избежать конфликтов между разными технологиями, использующими одинаковые имена тегов. Представьте, что это "фамилия" для тегов: тег `<a>` может быть ссылкой в HTML, а в SVG это тоже ссылка, только с другим поведением и атрибутами. Пространство имён говорит браузеру: "Этот `<a>` — из семейства HTML, а этот — из семейства SVG".
