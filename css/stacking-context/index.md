...
<iframe title="Стандартное поведение блоков" src="demos/default.html"></iframe>
...
Но мы можем не подчиняться стандартным правилам браузера и устанавливать свой порядок наложения элементов друг на друга. Для этого понадобиться свойство [`z-index`](/css/z-index).
...
<iframe title="Меняем порядок блоков при помощи z-index" src="demos/z-index.html"></iframe>
...
<iframe title="Жёлтый блок остаётся под сиреневым" src="demos/parent.html"></iframe>
...
<iframe title="Жёлтый блок остаётся поверх фона и рамки родителя" src="demos/under-bkg.html"></iframe>
