...
**Экономия ресурсов на разработку**: логические свойства CSS позволяют создавать стили сразу для всех возможных направлений интерфейсов, не нужно писать дополнительные стили для разных вариантов направлений письма.
