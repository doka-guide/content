...
💡 Важно помнить, что расчете порядкового номера дочернего элемента, участвуют все соседние дочерние элементы находящиеся на одном уровне с элементом, к которому мы применяем псевдокласс `:nth-last-child` вне зависимости от класса и типа элемента. 
