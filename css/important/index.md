...
В случае, если вам приходится иметь дело с элементами HTML-документа у которых заданы стили при помощи атрибута style,
модификатор `!important` сможет вам помочь переопределить стили.
