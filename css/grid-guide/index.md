...
Предостережение: не используйте гриды, если сайт должен корректно работать в старых браузерах. Если в вашем «зоопарке» есть старые браузеры, проверяйте поддержку технологии на [Can I use](https://caniuse.com/css-grid).
...
[Поддерживается](https://caniuse.com/mdn-css_properties_display_grid) всеми современными браузерами.
...
[Поддерживается](https://caniuse.com/mdn-css_properties_grid-auto-flow) всеми современными браузерами.
...
[Поддерживается](https://caniuse.com/mdn-css_properties_grid-template-areas) всеми современными браузерами.
...
[Поддерживается](https://caniuse.com/mdn-css_properties_grid-template) всеми современными браузерами.
...
Существуют старые аналоги этих свойств, которые могут пригодиться вам, если вы вынуждены поддерживать браузеры старше, чем Chrome 68, Safari 11.2 и Opera 54: `grid-column-gap` и `grid-row-gap`. Можно писать сперва старые свойства, а за ними новые. Чтобы наверняка.

Поддерживается всеми современными браузерами. Проверить поддержку свойств можно на Can I use: [column-gap](https://caniuse.com/mdn-css_properties_column-gap_context), [row-gap](https://caniuse.com/mdn-css_properties_row-gap_context).
...
Есть старое свойство-аналог для браузеров старше Chrome 68, Safari 11.2 и Opera 54: `grid-gap`.

[Поддерживается](https://caniuse.com/mdn-css_properties_gap_context) всеми современными браузерами.
...
[Поддерживается](https://caniuse.com/mdn-css_properties_justify-items_context) всеми современными браузерами.
...
[Поддерживается](https://caniuse.com/mdn-css_properties_align-items_context) всеми современными браузерами.
...
[Поддерживается](https://caniuse.com/mdn-css_properties_place-items_context) всеми современными браузерами.
...
[Поддерживается](https://caniuse.com/mdn-css_properties_grid-area) всеми современными браузерами.
...
[Поддерживается](https://caniuse.com/mdn-css_properties_justify-self_context) всеми современными браузерами.
...
[Поддерживается](https://caniuse.com/mdn-css_properties_align-self_context) всеми современными браузерами.
...
[Поддерживается](https://caniuse.com/mdn-css_properties_place-self_grid_context) всеми современными браузерами.
