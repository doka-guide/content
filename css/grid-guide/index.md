...
Предостережение: не используйте гриды, если сайт должен корректно работать в браузере IE 11 и ниже. Если в вашем «зоопарке» есть старые браузеры, проверяйте поддержку технологии на [Can I use](https://caniuse.com/css-grid).
...
Горизонтальная грид-полоса между первой и второгй грид-линиями ряда.
