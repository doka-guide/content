...
**Для small-caps (капитель)** браузер заменяет строчные буквы на уменьшенные заглавные. Капитель — это начертание, где вместо обычных строчных букв используются заглавные буквы меньшего размера. Настоящая капитель — это отдельно нарисованные символы с правильными пропорциями.
