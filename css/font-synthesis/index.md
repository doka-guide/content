...
💡 Свойство `font-synthesis-position` появилось позже остальных значений, и его поддержка в браузерах может отличаться. Проверяй совместимость перед использованием.
