...
Нейросети могут быть обучены на большом объеме данных, чтобы распознавать паттерны использования физических свойств CSS и преобразовывать их в соответствующие логические свойства. Но сейчас они всё ещё находятся на этапе развития и требуют за собой перепроверки.