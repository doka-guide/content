...
На этих скриншотах видно, что разметка сайта может быть разной - другое расположение элементов на странице, привычных западным пользователям, другие эстетические предпочтения в дизайне. Логические свойства помогают сделать хорошие интерфейсы без излишних усилий.
...
![Тот же сайт, если в инструментах разработчика прописать 'direction: rtl`](images/dtf-ltr.png)
