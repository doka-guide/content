...
Без каскадных слоёв нам нужно задать стили классу _.button_ с нужными псевдоклассами. При этом мы не можем хранить их в одном месте файла так, чтобы их случайно не перезаписали другие разработчики.
...
С каскадными слоями легче победить сторонние стили. Например, из Bootstrap. Например, мы хотим изменить размер заголовка первого уровня без мучительных поисков нужных Sass-переменных.
