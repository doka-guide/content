...
Помимо свойств, с помощью которых можно управлять счётчиками, создавать их, есть две основных функции для подставления значения счётчика `counter()` и `counters()`.
