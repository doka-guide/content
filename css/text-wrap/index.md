...
- `wrap` — значение по умолчанию. Текст переносится по строкам с использованием соответствующих символов (например, пробелов), для того, чтобы минимизировать переполнение.
