...
Оно устанавливает размеры окна отображения в _замещаемых_ элементах, вроде [`<img>`](/html/img/), [`<video>`](/html/video/), [`<canvas>`](/html/canvas/). Контент, попавший в заданную область, будет виден, а остальной скроется.
