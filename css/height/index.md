---
title: "`height`"
description: "Свойство для управления высотой элемента."
authors:
  - solarrust
contributors:
  - skorobaeus
...
В качестве значения пишем число, а за ним без пробела единицу измерения: `px`, `%`, `vh`, `rem`, `em` или любую другую [единицу измерения](/css/numeric-types/), доступную в вебе.
