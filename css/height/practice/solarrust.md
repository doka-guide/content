...
<iframe title="Высота складывается из padding — height — Дока" src="../demos/padding/index.html"></iframe>
...
<iframe title="Высота складывается из padding — height — Дока" src="../demos/padding-w-text/index.html"></iframe>
...
<iframe title="Минимальная высота плюс блок с padding — height — Дока" src="../demos/min-height-padding-w-text/index.html"></iframe>
...
<iframe title="Высота не указана — height — Дока" src="../demos/no-height/index.html"></iframe>
