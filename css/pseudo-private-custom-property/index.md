...
Может возникнуть такая ситуация, что дизайнеры создали классный дизайн для карточек продуктов, у которых цвет отличается в зависимости от типа товара (скидки, популярное, новое и так далее).
