...
3.  **`auto`:**
    Браузер оценивает ситуацию. Если есть место и аннотации не длинные, он может оставить их раздельными. Но если, как в примере, `じょう` очень длинная, он их объединит, чтобы избежать «рваной» вёрстки.
