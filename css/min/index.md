...
Поддерживается вложенность других функций, например [`calc()`](/css/calc/):
...
В примере выше используется `min(50vw, 350px)`, что означает: элемент занимает половину ширины [вьюпорта](/css/vw-vh/#vw), но не больше 350 px.
