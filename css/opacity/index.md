---
title: "`opacity`"
description: "Прячем элемент на странице, делая его полностью или частично прозрачным."
authors:
  - solarrust
keywords:
  - прозрачность
...
💡 Элемент не пропадает со страницы, продолжает влиять на [поток документа](/html/flow/).
