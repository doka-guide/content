...
**Важное исключение:** свойства фона ([`background`](/css/background/), `background-*`) применяются к каждой реплике отдельно, чтобы фон одной реплики не перекрывал другие реплики или слишком большую область видео.
