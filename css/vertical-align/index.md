...
<iframe title="Вертикальное выравнивание по умолчанию — vertical-align — Дока" src="demos/blocks-baseline/"></iframe>
...
<iframe title="Вертикальное выравнивание по верху — vertical-align — Дока" src="demos/blocks-top/"></iframe>
...
<iframe title="Вертикальное выравнивание по центру — vertical-align — Дока" src="demos/middle/"></iframe>

- `bottom` — выравнивает нижнюю границу элемента по уровню нижней границы строки.

<iframe title="Вертикальное выравнивание по низу — vertical-align — Дока" src="demos/bottom/"></iframe>
...
<iframe title="Нижний индекс при помощи vertical-align — vertical-align — Дока" src="demos/sub/"></iframe>

- `super` — работает почти как `sub`, только поднимает базовую линию вверх.

<iframe title="Верхний индекс при помощи vertical-align — vertical-align — Дока" src="demos/super/"></iframe>
...
<iframe title="Вертикальное выравнивание по нижней линии текста — vertical-align — Дока" src="demos/text-bottom/"></iframe>
...
<iframe title="Вертикальное выравнивание по верхней линии текста — vertical-align — Дока" src="demos/text-top/"></iframe>
