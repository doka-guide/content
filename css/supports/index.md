...
- Дальше браузер проверит, может ли он обработать свойство `grid-gap` со значением `8px`:
  - Если поддержка этого свойства есть, стили внутри директивы `@supports` применятся и перекроют наш фоллбек.
...
## Полезные материалы
Браузерные расширения, которые помогут посмотреть на `@supports` в действии, поиграть с условиями и потестировать фоллбеки:
