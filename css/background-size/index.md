...
<iframe title="Фон без управления размером — background-size — Дока" src="demos/fullsize.html"></iframe>
...
<iframe title="Фон с размером 100% 100% — background-size — Дока" src="demos/100-100.html"></iframe>
...
<iframe title="Фон с параметром cover — background-size — Дока" src="demos/cover.html"></iframe>
