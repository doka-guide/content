...
<iframe title="Выравнивание инлайн-блочных элементов в контейнере — text-align — Дока" src="../demos/block-align.html"></iframe>

Добавим элементу `.parent` свойство `text-align: center` и элементы `.child` выровняются по центру родителя:

<iframe title="Выравнивание по центру инлайн-блочных элементов в контейнере — text-align — Дока" src="../demos/block-align-2.html"></iframe>

А если попробовать распределить вложенные элементы равномерно по ширине родителя, задав `text-align: justify`?

<iframe title="Выравнивание по ширине инлайн-блочных элементов в контейнере — text-align — Дока" src="../demos/block-align-3.html"></iframe>
...
<iframe title="Выравнивание по ширине инлайн-блочных элементов в контейнере — text-align — Дока" src="../demos/block-align-4.html"></iframe>
