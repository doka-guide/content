...
<iframe title="Показываем отсутствие адаптивности расположения" src="demos/without-fallback/" height="580"></iframe>
...
<iframe title="Показываем работу значения flip-block" src="demos/flip-block/" height="580"></iframe>
...
<iframe title="Показываем работу значения flip-inline" src="demos/flip-inline/" height="580"></iframe>

При использовании `flip-inline` значения таргет элемент будет менять свое местоположение в строчном направлении (то есть по горизонтали для системы письменности справо-налево).
...
<iframe title="Показываем работу значения flip-start" src="demos/flip-start-1/" height="580"></iframe>
...
<iframe title="Показываем работу значения flip-start" src="demos/flip-start-2/" height="580"></iframe>
...
<iframe title="Показываем работу значения типа position-area" src="demos/position-area/" height="580"></iframe>
