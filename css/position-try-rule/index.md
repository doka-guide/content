...
Чтобы решить эту проблему была придумана директива `@position-try`, которая позволяет объединить под одним именем набор из нескольких CSS-свойств и затем применить их в качестве фолбэка внутри свойства [`position-try-fallbacks`](/css/position-try-fallbacks/).
