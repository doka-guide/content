...
2. Если применено свойство `list-style-image` на элементе списка. В таком случае будет отображаться указанное изображение.
3. Если применено свойство `list-style-type` на элементе списка. В таком случае будет отображаться маркер в виде строки.
