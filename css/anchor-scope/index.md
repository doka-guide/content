...
<iframe title="Сломанная демка с использование несколько раз одного и того же anchor-name" src="demos/without-anchor-scope-1/" height="500"></iframe>
...
<iframe title="Сломанная демка с использование несколько раз одного и того же anchor-name (с отступами)" src="demos/without-anchor-scope-2/" height="500"></iframe>
