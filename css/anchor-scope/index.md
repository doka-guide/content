...
Свойство `anchor-scope` ограничивает облать применения указанных якорных имён в поддереве текущего элемента.
...
<iframe title="Сломанная демка с использование несколько раз одного и того же anchor-name" src="demos/without-anchor-scope-1/" height="480"></iframe>
...
<iframe title="Сломанная демка с использование несколько раз одного и того же anchor-name (с отступами)" src="demos/without-anchor-scope-2/" height="480"></iframe>

В данном примере мы использовали одно и то же якорное имя для нескольких элементов.

![Объяснение поломонной демки, часть 1](images/broken-demo-explanation-1.png)
...
![Объяснение поломонной демки, часть 2](images/broken-demo-explanation-2.png)
...
Чтобы решить подобную проблему было придумано свойство `anchor-scope`, которое позволяет ограничить видимоть якорного имени поддеревом конкретного элемента.
...
<iframe title="Работающая демка на основе anchor-scope" src="demos/with-anchor-scope/" height="540"></iframe>
