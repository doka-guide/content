...
С помощью ключевое слова `currentColor` можно задать [цвет](/css/web-colors), соответствующий текущему значению свойства [`color`](/css/color) у элемента.
