...
Значение по умолчанию. Статическое позиционирование. Любой элемент, добавленный на страницу, будет иметь это значение и будет расположен в [нормальном потоке](/html/flow) документа согласно контексту форматирования родительского элемента. Свойства `left`, `right`, `top`, `bottom` и [`z-index`](/css/z-index) игнорируются.
...
<iframe title="Относительное позиционирование" src="demos/relative/" height="340" sandbox></iframe>
...
<iframe title="Абсолютное позиционирование" src="demos/absolute/" height="350" sandbox></iframe>
...
<iframe title="Фиксированное позиционирование" src="demos/fixed/" height="580" sandbox></iframe>
...
<iframe title="Липкое позиционирование" src="demos/sticky/" height="300" sandbox></iframe>
...
<iframe title="Положение по второй оси при нестатичном позиционировании" src="demos/absolute-sec-axis/" height="580" sandbox></iframe>
