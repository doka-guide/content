...
<iframe title="Название — Функции CSS-трансформации — Дока" src="demos/ezhkov-GRZzQBZ"></iframe>
...
<iframe title="Название — Функции CSS-трансформации — Дока" src="demos/ezhkov-MWbZqKJ/index.html"></iframe>

Если же мы используем индивидуальные свойства, результат будет одинаковым вне зависимости от порядка свойств:

<iframe title="Название — Функции CSS-трансформации — Дока" src="demos/ezhkov-yLVGxVg"></iframe>
