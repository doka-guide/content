...
Подробнее об этой функции написано в доке [`scale()`](/css/scale/).
...
Подробнее о функции `skew` написано в статье «[Искажаем и наклоняем элементы с пониманием.](/css/skew/)».
