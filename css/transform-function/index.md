...
<iframe title="Песочница свойства transform" src="demos/sandbox/" height="300"></iframe>
...
<iframe title="Порядок функций" src="demos/funcs-order/" height="310"></iframe>

Если же мы используем индивидуальные свойства, результат будет одинаковым вне зависимости от порядка свойств:

<iframe title="Правильный порядок функций" src="demos/funcs-right-order/" height="310"></iframe>
