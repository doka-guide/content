...
description: "С помощью этого набора функций можно исказить реальность. Хотя бы в пределах веб-страницы 😉"
authors:
  - ezhkov
editors:
  - tachisis
...
Подробнее об этой функции написано в доке [`scale()`](/css/scale-function/).
...
Подробнее о функции `skew` написано в статье «[Искажаем и наклоняем элементы с пониманием.](/css/skew-function/)».
