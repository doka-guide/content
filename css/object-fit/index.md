...
<iframe title="Искажённая картинка" src="demos/no-fit/" height="448" sandbox></iframe>
...
<iframe title="Картинка полностью помещается" src="demos/fit/" height="448" sandbox></iframe>
...
<iframe title="Варианты object-fit" src="demos/every/" height="500" sandbox></iframe>
