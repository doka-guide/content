...
<iframe title="Обычный textarea — <textarea> — Дока" src="demos/basic/index.html" height="270"></iframe>
...
Если атрибут не указать совсем, то браузер будет брать значение из атрибута `autocomplete` родительского элемента [`<form>`](/html/form), либо — если родительской формы нет — из той формы, на `id` которой ссылается атрибуте `form`.
...
<iframe title="Textarea - cols — <textarea> — Дока" src="demos/cols/index.html" height="620"></iframe>
...
<iframe title="Textarea - disabled — <textarea> — Дока" src="demos/disabled/index.html" height="270"></iframe>
...
<iframe title="Textarea - maxlength — <textarea> — Дока" src="demos/max/index.html" height="270"></iframe>
...
<iframe title="Textarea - placeholder — <textarea> — Дока" src="demos/placeholder/index.html" height="270"></iframe>
...
<iframe title="Textarea - rows — <textarea> — Дока" src="demos/rows/index.html" height="660"></iframe>
