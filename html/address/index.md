...
- Внутри нельзя использовать заголовки, секционные теги ([`<section>`](/html/doka/section/), [`<article>`](/html/article/), [`<aside>`](/html/aside/), [`<nav>`](/html/doka/nav/)), а так же теги [`<header>`](/html/doka/header/) и [`<footer>`](/html/doka/footer/)
