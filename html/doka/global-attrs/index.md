...
- [`class`](/html/doka/class) — значение: один или несколько классов для HTML-элемента, разделённые запятой. Позволяет выбирать конкретный элемент / элементы при помощи CSS или JavaScript.
