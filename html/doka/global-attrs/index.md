...
Ниже вы найдете список глобальных атрибутов с кратким описанием каждого.
...
- `spellcheck` — значение: булевое значение `true`/`false`. С помощью этого атрибута мы указываем браузеру, что в этом элементе нужно проверить правописание.
