...
Элемент `<dl>` аналогично элементам [`<ul>`](/html/ul/) и [`<ol>`](/html/doka/ol/) является внешней обёрткой для элементов списка.
...
💡 В отличие от списков [`<ul>`](/html/ul/) и [`<ol>`](/html/doka/ol/) группы терминов и определений, с недавних пор и по просьбе разработчиков, можно оборачивать в [`<div>`](/html/doka/div/).
