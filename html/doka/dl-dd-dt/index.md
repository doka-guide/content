...
Элемент `<dl>` аналогично элементам [`<ul>`](/html/doka/ul/) и [`<ol>`](/html/ol/) является внешней обёрткой для элементов списка.
...
💡 В отличие от списков [`<ul>`](/html/doka/ul/) и [`<ol>`](/html/ol/) группы терминов и определений, с недавних пор и по просьбе разработчиков, можно оборачивать в [`<div>`](/html/doka/div/).
