...
💡 `<nav>` — это один из ориентиров (landmark), которые скринридеры могут использовать для навигации по странице. То есть можно прямо перейти блок навигации по сайту, это очень удобно.
