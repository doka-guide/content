...
- Внутри нельзя использовать заголовки, секционные теги ([`<section>`](/html/section/), [`<article>`](/html/doka/article/), [`<aside>`](/html/doka/aside/), [`<nav>`](/html/doka/nav/)), а так же теги [`<header>`](/html/doka/header/) и [`<footer>`](/html/doka/footer/)
