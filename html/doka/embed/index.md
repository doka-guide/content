...
- `width` — ширина в пикселях, проценты не допустимы. Указывается только число, без единиц измерения.
- `height` — высота в пикселях, проценты не допустимы. Указывается только число, без единиц измерения.
