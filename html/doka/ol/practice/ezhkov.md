...
🛠 Упорядоченные списки на сайтах могут использоваться в текстах, где явно требуется нумерация. Другой вариант использования часто можно увидеть на медиасервисах: упорядоченными списками свёрстаны плейлисты в музыкальной библиотеке.
