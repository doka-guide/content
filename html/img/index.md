...
Подробнее о том, что записывать в `alt`, узнаете из «[Как описывать картинки](/a11y/how-to-describe-pictures/)».
...
💡 Картинка может быть ссылкой: для этого оберните `<img>` в [`<a>`](/html/a/).
