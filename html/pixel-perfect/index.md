...
<html>
  ...
  <head>
    <!-- Контент страницы -->
    <img class="pixel-perfect-image" src="ссылка-на-изображение.png">
  </head>
</html>
```
...
![Интерфейс расширения](images/interface.png)
...
- <kbd>Control</kbd> + <kbd>Command</kbd> + <kbd>I</kbd> — на macOS;
...
![Окно браузера с открытыми инструментами разработчика и включенным режимом отзывчивого дизайна](images/adaptive.png)
