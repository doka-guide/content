...
<iframe title="Тег nobr — Устаревшие теги — Дока" src="demos/nobr/index.html" height="280"></iframe>
...
Для автоматического воспроизведения музыкального файла. В отличие от современного использования встраивания аудио-контента с помощью `<embed>` или [`<audio>`](/html/audio), не отображает на странице кнопок управления (стоп, пауза, громкость). Такая бесконтрольность допускала злоупотребление этим эффектом. Поддержка тега была реализована только в Internet Explorer.
...
<iframe title="Тег marquee — Устаревшие теги — Дока" src="demos/marquee/index.html" height="360"></iframe>
...
<iframe title="Имитация marquee — Устаревшие теги — Дока" src="demos/marquee-fallback/index.html" height="280"></iframe>
