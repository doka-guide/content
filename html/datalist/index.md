...
У тега по умолчанию есть [роль `listbox`](/a11y/role-listbox/). Это делает `<datalist>` полезным для [скринридеров](/a11y/screenreaders/) и других вспомогательных технологий.
