...
- Для инструментов доступности `<dialog>` воспринимается как аналог [`role="dialog"`](/a11y/role-dialog/). А если оно открыто в режиме модального окна, то и как аналог [`aria-modal="true"`](/a11y/aria-modal/).
