...
💡 Ссылка не всегда по умолчанию становится строчным элементом. Если ссылка будет прямым потомком `flex`- или `grid`-контейнера, то браузер определит её значение `display` как `block`. Таким ссылкам можно свободно  задать ширину, высоту, а также `padding-top` и `padding-bottom`, в то время как для ссылки-ребенка блочного или строчного родителя эти свойства действовать корректно не будут, как и для любого другого `inline`-элемента, если, конечно же, мы не зададим иное значение `display` явно.
