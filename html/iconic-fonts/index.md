...
- Неконсистентность: разные браузеры и операционные системы применяют свои алгоритмы сглаживания шрифтов (_anti-aliasing_), из-за чего иконки могут выглядеть иначе, чем задумал дизайнер, и заметно различаться на разных устройствах.
...
- Несемантичность и потенциальные проблемы с SEO: Иконки, реализованные через шрифты, по сути это текст (псевдоэлементами [`::before`](/css/before/) с юникод-символами). Для поисковых систем этот текст — бессмысленный набор символов, который не несёт полезной информации и может потенциально снижать качество выдаваемого контента, в отличие от семантически верной разметки с SVG.
