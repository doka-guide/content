...
Реальный пример, где хорошо подошёл бы `<meter>`, — шкала с используемыми в проекте языкам на GitHub.
...
- `-webkit-meter-bar` — стили внутри `<meter>`.
...
- `-webkit-meter-even-less-good-value` — цвет фона для отрицательного значения за пределами диапазона `low` и `high`. По умочанию красный.

Давайте поиграем с цветами 👨‍🎨
...
<iframe title="Стилизованный тег meter" src="demos/custom-styles/" height="400"></iframe>
