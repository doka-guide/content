...
Попробовать как изменяется внешний вид тега в зависимости от выбранных значений можете попробовать в этой песочнице. По мотивам примера «[HTML5 Meter Element](https://codepen.io/pankajparashar/pen/GnFpA)» <!-- yaspeller ignore:start -->Панкаджа Парашара<!-- yaspeller ignore:end -->.
