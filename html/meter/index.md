...
`<meter>` — парный тег, который нужно закрывать.

К тегу можно добавить подпись. Лучше всего добавлять её с помощью старого-доброго [`<label>`](/html/label/). 
...
- `form` — дополнительный атрибут для связи формы со счётчиком, когда он не вложен внуть [`<form>`](/html/form/).
