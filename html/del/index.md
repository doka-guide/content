...
У тега по умолчанию есть [роль `deletion`](/a11y/role-deletion/). Это значит, что тег имеет смысл для [скринридеров](/a11y/screenreaders/) и других вспомогательных технологий.
