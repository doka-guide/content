...
_Поповер_ — это любые всплывающие элементы в интерфейсе: всплывающие подсказки (тултипы), раскрывающиеся меню, превью товаров и другие. Поповеры входят в группу попапов. В неё же включают, например, [`<dialog>`}(/html/dialog/).
...
В чём отличие поповеров от такого же нового [`<dialog>`](/html/dialog/)? Кажется, что оба создают всплывающие окна.
