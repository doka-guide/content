...
**Улучшение SEO:** используйте `rel="nofollow"`, чтобы поисковики не передавали «вес» страницы по ссылке. А `rel="noopener"` защищает от уязвимостей при открытии новых вкладок.
