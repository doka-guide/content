...
При использовании семантических тегов легче поддерживать исходный код проекта в будущем. Куда удобнее ориентироваться в коде, если он состоит из семантических тегов. Так любому члену команды будет понятна логика и структура интерфейса. 
...
Семантическая вёрстка также помогает избежать рефакторинга кода в будущем, если начнёте улучшать доступность сайта.
