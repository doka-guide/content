...
**Первый шаг**. Вы смотрите на крупные блоки всего сайта и выделяете их под теги для блоков. Например, `<header>`, `<footer>`, `<main>`, `<nav>` или `<aside>`. Обычно эти блоки повторяются на всех страницах.
