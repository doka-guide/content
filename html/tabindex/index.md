...
`tabindex` так называется из-за клавиши <kbd>Tab</kbd>, которой перемещаются между интерактивными элементами. Это действие часто называют «табать» или «протабать».
