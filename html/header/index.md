...
💡 Семантический вес для [скринридеров](../../a11y/screenreaders/) тег `<header>` имеет только в случае, если он напрямую вложен в тег `<body>`. Т.е. выступает в роли обчной "шапки" страницы. В этом случае у `<header` будет ARIA роль [`banner`](../../a11y/role-banner/). Благодаря этой роли пользователи скринридеров могут быстро перемещаться к этой области с помощью специальных клавиш. Во всех остальных случаях тег `<header>` не будет иметь семантического значения для скринридеров.
