...
На странице может быть сколько угодно тегов `<header>`. Но их нельзя помещать в контейнеры [`<footer>`](/html/footer/), [`<address>`](/html/address/) или другой `<header>`.
