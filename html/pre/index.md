...
Тег `<pre>` – (от английского _preformatted text_ ) нужен для отображения предварительно отформатированного текста, если необходимо сохранить все пробелы и переносы из HTML.
...
💡 Для демонстрации внутри тега `<pre>` HTML-кода могут возникнуть проблемы с отображением тегов в угловых скобках – браузер не будет их выводить, т. к. посчитает служебными. Чтобы решить проблему, воспользуйтесь спецсимволами.
