В JavaScript массивы — это не отдельный тип данных, а просто [объекты](/js/objects-objects-everywhere/). Заполненные элементы массива хранятся под числовыми ключами, а пустые ячейки вообще не существуют.
