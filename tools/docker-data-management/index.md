...
foo
``` 
Диск foo создан с размером 100 мб с доступом пользователю с id=1000 по пути /mnt/bc72cea2-147f-4545-876a-92e32b23223a/port_vol тип overlay2 можно не указывать, так как это дефолтное значение для драйвера dockera старше 18.04
