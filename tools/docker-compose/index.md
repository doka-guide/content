...
Docker Compose поддерживает файлы конфигурации в формате [YAML](http://yaml.org/). Имя файла конфигурации по умолчанию — _compose.yaml_. Для нашего примера такой файл мог бы выглядеть следующим образом (в качестве базы данных будем использовать MySQL):
