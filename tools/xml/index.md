...
После введения атрибута `xmlns` наобходимо добавить тегам префикссы с двоеточием `classic:` и `catName:`, тогда код будет обрабатываться правильно и выглядеть так:
