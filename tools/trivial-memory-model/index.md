...
Помните, что это модель. В реальности кто и как запускаем поток зависит от того, на чём и для чего пишите программу. Посмотрите, например, [вот сюда](https://en.wikipedia.org/wiki/Pthreads).
