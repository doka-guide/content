...
Помните, что это модель. В реальности кто и как запускает поток зависит от того, на чём и для чего пишите программу. Посмотрите, например, [на POSIX Threads](https://en.wikipedia.org/wiki/Pthreads).
