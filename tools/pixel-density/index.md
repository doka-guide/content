...
Помимо консольных утилит можно встретить инструменты, в которых используется искусственный интеллект. Например, для подготовки изображения с различной плотность пикселей, можно воспользоваться:
