...
__Репозиторий__ — это общее название для хранилища исходного кода. Часто говорят об __удаленном репозитории__ (копия кода на каком-то сервере) и __локальном репозитории__ (копия на компьютере разработчика).
...
![Линейная история коммитов](images/git_01.png)
...
![Сливание ветки в репозиторий](images/git_02.png)
