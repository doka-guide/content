...
Часто можно сказать, насколько код программы корректен, даже не запуская ее. Процесс исследования исходного кода без запуска называют __статическим анализом__ или __линтингом__, а программу, которая это делает — __статическим анализатором__ или __линтером__.
