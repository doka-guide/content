...
- вспомогательные инструменты для клиентских приложений — системы сборки <!--TODO: Ссылку на системы сборки-->, распространения пакетов <!--TODO: Ссылку на менеджеры пакетов-->, серверы разработки, редакторы кода и системы статического анализа <!--TODO: Ссылку на системы статического анализа-->;
