...
Сейчас уже не встретишь проекта, где код напрямую бы отправлялся клиентам — все приложения проходят через этап сборки<!--TODO: Проставить ссылки на системы сборки -->. В мире JS существует довольного много разных сборщиков, но самый популярный — Webpack.
