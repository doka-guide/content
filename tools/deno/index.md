...
Пример запуска скрипта с параметрами доступа к файловой системе. Содержимое файла _my-other-script.js_:
