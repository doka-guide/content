...
Чаще всего причиной сдвигов становятся изображения без указанных размеров. Также часто причиной становятся поздно загружаемые шрифты и динамический контент: реклама, баннеры согласия с cookies, всплывающие плашки. Список возможных причин:
...
- **Баннеры cookie-уведомлений** - частый и недооценённый источник CLS: на мобильных экранах такой баннер занимает заметную долю вьюпорта, а его текст может стать LCP-элементом. Заранее устанавливайте соединение с доменом баннера через `preconnect`/`dns-prefetch`, если он внешний, и резервируйте место под него так же, как под любой другой поздно подгружаемый блок;
