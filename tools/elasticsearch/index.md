...
Для работы нам нужно инициализировать проект и поставить либу для ES. Чтобы развернуть проект используем [express-generator](https://expressjs.com/ru/starter/generator.html) - генератор приложений для Express.js:
