...
Обо всех статусах можно прочитать в документации или на специальном [ресурсе](https://httpstatuses.com), который даёт информацию в сжатом и удобном для разработчика виде.
