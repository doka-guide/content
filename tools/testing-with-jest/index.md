...
![Консольный вывод запуска теста. Зёленые галочки показывают, что тест проходит.](images/pass.png)
...
![Консольный вывод запуска теста. Красные крестики показывают, что тест не проходит.](images/fetch-failing.png)
...
![Консольный вывод запуска теста. Красные крестики показывают, что тест не проходит.](images/fetch-keep-failing.png)
...
![Консольный вывод запуска теста. Зёленые галочки показывают, что тест проходит.](images/fetch-passing.png)
...
![Консольный вывод запуска теста. Зёленые галочки показывают, что последний тест проходит.](images/fetch-passing.png)
...
![Консольный вывод запуска теста. Красные крестики показывают, что тест не проходит. Выводится сообщение об ошибке: Jest не может найти DOM](images/article-aside-failing.png)
...
![Консольный вывод запуска теста для article-aside. Зёленые галочки показывают, что тест проходит.](images/article-aside-passing.png)
