...
![Нативное модальное окно с предложением установить Squoosh. Визуальное сравнение мобильной и десктопной версии одного окна.](images/pwa-install.png)
Установка PWA в браузере Chromium на операционных системах Android и ChromiumOS
