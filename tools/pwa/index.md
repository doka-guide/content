...
Даже один и тот же браузер в различных операционных системах может иметь неодинаковую поддержку Web API.

А в iOS все браузеры (Chrome, Firefox и др.) вынуждены вместо своего собственного движка (Blink, Gecko и др.) использовать движок WebKit, используемый браузером Safari, который либо не поддерживает некоторые Web API, либо поддерживает их частично.
