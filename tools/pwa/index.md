...
![Мобильный и десктопный браузеры, в обоих при переходе на сайт Squoosh всплыло нативное окно с предложением установить приложение](images/pwa-install.png)
