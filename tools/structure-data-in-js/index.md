...
![Массив из четырёх элементов. Индекс первого элемента — 0, второго — 1, третьего — 2, четвёртого — 3.](images/array.png)
...
![В очереди четыре элемента. Слева, в конце очереди, четвёртый элемент, справа, в самом начале — первый. Пятый элемент добавляется в конец после четвёртого, а удаляется сначала первый.](images/queue.png)
