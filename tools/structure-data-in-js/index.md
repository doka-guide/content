...
![Визуализация структуры данных дерева, включая названиями элементов](images/trees.png)
...
![Визуализация бинарного дерева](images/binary-search-tree.png)
...
![Визуализация обычного графа с названиями элементов](images/graph.png)
...
![Визуализация напрваленного и ненаправленного графа](images/types-of-graphs.png)
