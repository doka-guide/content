...
🏛 Это статья из цикла об [архитектуре и шаблонах проектирования](/tools/architecture-and-design-patterns/). Их необходимость и пользу мы рассматриваем в первой статье из цикла. В этой и других статьях — рассматриваем каждый подход отдельно.
...
🐕 Концептуально _модель_ похожа на _домен_ из [трёхслойной архитектуры](/tools/clean-architecture/).
...
✈️ Это называется однонаправленным [потоком данных](/tools/architecture-data-flow/).
