...
Один из способов использования — это [настройка Github Actions](/tools/github-actions/). Это очень полезная штука, которая позволяет проверять пулреквесты по заданным в YAML-конфигах правилам.
