...
Less и SCSS похожи синтаксисом на современный CSS, различий довольно немного.

К примеру, на первый взгляд трудно найти отличия между CSS и SCSS, если не использовать дополнительные фичи препроцессора:
