...
☝️ Удобно следить за статистикой по препроцессорам в [ежегодных отчётах о состоянии CSS](https://stateofcss.com/en-US). Так, за четыре года c 2019 по 2022, использование препроцессоров снизилось на 8 %, а их популярность — на 6 %.
