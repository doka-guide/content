...
Специальных CSS-функций для работы с цветами тоже пока ещё всё нестабильно: их не так много и у них пока нет хорошей поддержки браузерами. Так что с цветами по-прежнему сложно работать без препроцессоров.
...
Поиграть с разными возможностями SCSS и похожим на него Sass можно в [Sass Playground](https://sass-lang.com/playground/).
