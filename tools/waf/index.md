...
Из-за большого количества уязвимостей, WAF рекомендуется для любых сайтов, особенно, для тех, где присутствует бэкенд.
...
Это упрощённый пример любого веб-сайта на сервере Angie
```nginx
server {
