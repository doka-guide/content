...
В последние годы появилась возможность использования ещё двух форматов: [zopfli](https://ru.wikipedia.org/wiki/Zopfli) и [brotli](https://ru.wikipedia.org/wiki/Brotli). Наиболее перспективным и эффективным является brotli. Вы можете посмотреть поддержку этого формата сжатия в браузерах на [Can I Use](https://caniuse.com/brotli).
...
Подробнее о типах веб-приложений написано в статье «[Виды веб-приложений](/js/articles/web-app-types)».
