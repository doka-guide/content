...
**Cильная статическая** типизация в TypeScript позволяет избежать множество ошибок при написании кода. Однако это не позволяет конструкциям языка работать с любыми типами данных. 
