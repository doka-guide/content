...
- [`runner`](https://docs.github.com/en/actions/reference/context-and-expression-syntax-for-github-actions#runner-context) — хранит информацию о раннере, в котором запущен текущий джоб;
