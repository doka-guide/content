...
Файл можно назвать произвольно, указать расширение _.yml_ и поместить в папку _.github/workflows_. Экшен автоматически запуститься и выдаст результаты проверки на отдельной вкладке «Actions».
