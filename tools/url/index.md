...
В таком случае `admin` это логин, `123` пароль, а `@www.example.com` имя хоста. Авторизация пройдёт автоматически, потому что браузер возьмёт всю информацию из ссылки.
