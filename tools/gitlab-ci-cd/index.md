...
GitLab CI — инструмент, встроенный в GitLab для автоматизации рутинных задач, возникающих в процессе разработки программного обеспечения. Спектр таких задач огромен и отличается от проекта к проекту, но основные — это [тестирование](/js/how-to-test-and-why/), [статический анализ](/tools/static-analysis/), [проверка стиля написания кода](/js/code-style/) и деплой (выпуск) приложения. GitLab CI — конкурент другого популярного инструмента, [GitHub Actions](/tools/github-actions/). Эти два сервиса во многом похожи, но есть некоторые отличия.
