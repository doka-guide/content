...
Для передачи результов сборки (бинарных файлов, логов, конфигураций и т.д.) между джобами используется **артефакты**. **Артефакт** - общий ресурс пайплайна, хранящийся отдельно и передающийся между этапами сборки. 
