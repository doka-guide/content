...
<iframe title="Пример README.md" src="demos/example" height="323"></iframe>
...
<iframe title="Перенос строк" src="demos/line-break" height="266"></iframe>
...
<iframe title="Заголовки через решётки" src="demos/atx-style" height="336"></iframe>
...
<iframe title="Заголовки через подчёркивания" src="demos/setext-style" height="391"></iframe>
...
<iframe title="Маркированный список" src="demos/marked-list" height="226"></iframe>
...
<iframe title="Разные маркеры" src="demos/different-markers" height="154"></iframe>
...
<iframe title="Упорядоченный список" src="demos/ordered-list" height="122"></iframe>
...
<iframe title="«Ленивая нумерация»" src="demos/ordered-list" height="122"></iframe>
...
<iframe title="Упорядоченный список с 99" src="demos/ordered-list-starts-with" height="122"></iframe>
...
<iframe title="Вложенные списки" src="demos/list-nesting" height="258"></iframe>
...
<iframe title="Многострочная цитата" src="demos/quote1" height="135"></iframe>
...
<iframe title="Многострочная цитата" src="demos/quote2" height="345"></iframe>
...
<iframe title="Вложенная цитата" src="demos/quote-nesting" height="172"></iframe>
...
<iframe title="Однострочный код" src="demos/code-inline" height="186"></iframe>
...
<iframe title="Многострочный код" src="demos/code-intend" height="264"></iframe>
...
<iframe title="Выделение текста" src="demos/emphasis" height="266"></iframe>
...
<iframe title="Экранирование выделения" src="demos/emphasis-escape" height="186"></iframe>
...
<iframe title="Ссылка" src="demos/link-inline" height="74"></iframe>
...
<iframe title="Ссылка" src="demos/link-ref" height="74"></iframe>
...
<iframe title="Автоматические ссылки" src="demos/link-auto" height="122"></iframe>
...
<iframe title="Горизонтальные разделители" src="demos/hr" height="148"></iframe>
...
<iframe title="Таблица" src="demos/table" height="183"></iframe>
...
<iframe title="Таблица с выравниванием" src="demos/aligned-table" height="183"></iframe>
...
<iframe title="Список задач" src="demos/tasks-list" height="183"></iframe>
...
```
<iframe title="Зачёркивание" src="demos/strikethrough" height="98"></iframe>
...
```md
Все вопросы по тегу [tag:javacript] на нашем сайте.
```
...
Многие мессенджеры, например Telegram или Discord, используют упрощённую версию Markdown. Там отсутствует разметка заголовков, списков и цитат, но поддерживается расширенный синтаксис выделения текста: жирные шрифты, курсив, зачёркивания, ссылки, разметка исходного кода.
