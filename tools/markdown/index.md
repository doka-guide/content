...
<iframe title="Перенос строк" src="demos/lineBreak" height="264"></iframe>
...
<iframe title="Заголовки через решётки" src="demos/atxStyle" height="318"></iframe>
...
<iframe title="Заголовки через подчёркивания" src="demos/setextStyle" height="377"></iframe>

### Списки
#### Маркированные
Для создания маркированных (ненумерованных) списков, перед каждым пунктом нужно поставить минус (`-`), плюс (`+`) или звёздочку (`*`). Маркер и текст пункта необхожимо разделять пробелом.
...
<iframe title="Маркированный список" src="demos/markedList" height="224"></iframe>
...
<iframe title="Разные маркеры" src="demos/differentMarkers" height="152"></iframe>
...
<iframe title="Упорядоченный список" src="demos/orderedList" height="120"></iframe>
...
<iframe title="«Ленивая нумерация»" src="demos/orderedList" height="120"></iframe>
...
<iframe title="Упорядоченный список с 99-ти" src="demos/orderedListStartsWith" height="120"></iframe>

#### Вложенность
Любые списки можно влкадывать друг в друга, для этого перед маркером нужно поставить таб или несколько пробелов.
...
💡 Чтобы не высчитывать размер отступа, можно просто всегда ставить первый символ дочернего маркера под первый символ родительского пункта:
```md
1. Родительский пункт
   1. Дочерний пункт

999999999. Родительский пункт
           1. Дочерний пункт
```
...
<iframe title="Вложенные списки" src="demos/listNesting" height="257"></iframe>
...
<iframe title="Вложенная цитата" src="demos/quoteNesting" height="182"></iframe>
...
- Обернуть код одной-двумия парами бэктиков (``` `код` ```)
...
<iframe title="Однострочный код" src="demos/codeInline" height="184"></iframe>

#### Три и более пар бэктиков
Если оберунть одну строчку кода тремя или более парами бэктиков, то мы получим строчный элемент, а если несколько строчек, то — блочный. Второй вариант позволяет указывать язык программирования, который мы используем, для этого нужно написать его сразу после открывающих бэктиков.
...
<iframe title="Многострочный код" src="demos/codeBlock" height="288"></iframe>

#### Отступ
Другой способ выделить код — поставить перед ним таб или 4&nbsp;пробела. Исоходный код необходимо отделять пустой строкой от предыдущего блока.
...
<iframe title="Многострочный код" src="demos/codeIntend" height="265"></iframe>
...
<iframe title="Экранирование выделения" src="demos/emphasisEscape" height="160"></iframe>
...
<iframe title="Ссылка" src="demos/linkInline" height="72"></iframe>
...
<iframe title="Ссылка" src="demos/linkRef" height="72"></iframe>
...
<iframe title="Автоматические ссылки" src="demos/linkAuto" height="96"></iframe>
...
[GFM](https://github.github.com/gfm) — один из диалектов Markdown, который, как можно догадаться из названия, используется на GitHub. Он основывается на спецификации CommonMark и расширяет её дополнительными элементами: таблицами, спискасм задач и зачёркиваниями.
...
<iframe title="Таблица с выравниванием" src="demos/alignedTable" height="181"></iframe>
...
<iframe title="Список задач" src="demos/tasksList" height="216"></iframe>
...
## На практике
### [Сергей Минаков](https://github.com/cergmin)
