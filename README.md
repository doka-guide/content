...
1. Скопируйте шаблон нужного вам формата в папку и переименуйте его в `index.md`.
...
1. Дополнительные материалы: картинки, демки, видео сохраняйте в ту же папку, в подпапки `images`, `demos`, `prectice` и т. п.
...
1. Закончили? Создайте пулл-реквест.

Вот и все! После небольшой проверки ваш материал появится на сайте Доки!
