...
В зависимости от операционной системы и её настроек, установка веб-сервера и настройка файервола будет отличаться, но базовые принципы сохраняться. Рассмотренное ниже решение представлено для Oracle Linux.
