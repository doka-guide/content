...
Уберём рамку у `<fieldset>`, сбросим стандартные стили кнопок и маркеры списка. Скроем текст, предназначенный для скринридеров. Поставим звёзды в ряд, зададим между ними отступ и сделаем их большими.
