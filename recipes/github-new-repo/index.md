...
Это удобно когда репозиторий создаётся для нового проекта.
Не нужно добавлять эти файлы или выбирать лицензию если GitHub-репозиторий будет использован для размещения уже существующего (локального) git-репозитория.
