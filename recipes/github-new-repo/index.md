...
Добавление файлов _README.md_, _.gitignore_ или выбор лицензии создаст первый коммит. Не стоит выбирать ни один из этих вариантов, если в GitHub-репозиторий вы будете заливать уже существующий локальный git-репозиторий, так как это может привести к конфликту слияния.
...
Первая команда переименовывает основную ветку вашего репозитория и не обязательна. Если ваша основная ветка называется иначе, вместо `main` нужно будет указать то название ветки, которое используете вы.
