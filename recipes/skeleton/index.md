...
Скететон это аналог спиннера, но более приятный для восприятия. Пользователь не только видит, что страница загружается, но и примерно понимает, какой контент появится после загрузки.
