...
Перeд разбором каждого из решений разберёмся со стартовым кодом. Во всех примерах зададим 100% высоты окна браузера для `<html>` и `<body>`, чтобы страница растянулась по высоте.
...
По вертикали от верхнего края хотим оттолкнуть элемент на 50% минус половина высоты элемента. В нашем случае это 100 пикселей. Будем использовать функцию [`calc()`](/css/calc/):
