...
![Пример паттерна использование ссылки и кнопки в названии вложенного меню](image.png)
