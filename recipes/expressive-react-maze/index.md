...
Префикc генерируется из хеша содержимого файла. Вы можете добавить специальные правила в файл настройки _vite.config.js_, чтобы изменить способ генерации префикса.
