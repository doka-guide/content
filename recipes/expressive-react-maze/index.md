...
Даже когда кажется, что всё работает как мы и хотели, стоит потратить немного времени на опыт взаимодействия (UX). Текущее решение содержит один неучтённый нюанс: после нажатия на кнопку "Апорт!" пользователь может добавить несколько стенок в лабиринте до того как начнётся анимация. При этом у собачки появляются суперспособности проходить сквозь стены. Для устранения этой недокументированной возможности нам потребуется запретить обработку нажатий на кнопки добавления стен лабиринта, как только была нажата кнопка "Апорт!" и до момента окончания анимации. Для этого можно добавить ещё одну переменную-состояние, что бы знать когда можно, а когда нельзя строить стены. Попробуйте добавить это исправление самостоятельно.
