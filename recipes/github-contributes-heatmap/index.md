...
Мы хотим отображать общее количество комитов за год.
Кроме этого определим минимальное и максимальное число комитов за день. Добавим функцию получения этих данных из массива сформированного ранее:
...
Как отмечалось ранее, идея визуализации тепловой карты состоит в отображении данных с помощью цвета. В нашем случае данные — это число коммитов за день. Чем больше это число, тем ярче цвет плитки.

Следует учесть зависимость количества цветов от порядка чисел. Чем больший диапазон чисел требуется отобразить тем больше цветов потребуется. С другой стороны, чем больше цветов, тем меньше заметна разница между ними.

Добавим константы для определения минимального и максимального количества цветов.
Определим базовый цвет палитры (цвет соответствующий максимальному количеству коммитов).
...
Определим требуемое количество цветов и сформируем палитру:
