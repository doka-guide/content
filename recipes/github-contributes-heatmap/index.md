...
Мы хотим отображать общее количество комитов за год рядом с названием репозитория.
Кроме этого определим минимального и максимального числа комитов за день. Добавим функцию получения этих данных из массива сформированного ранее:
