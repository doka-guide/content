...
Так же можно не писать несколько [медиа запросов](/css/media/), а воспользоваться функцией `clamp()` и рассчитывать нужную ширину `.container` для каждой ширины экрана.
...
- Первое параметр `360px` — задаёт минимальное значение ширины блока.
