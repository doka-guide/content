...
<iframe title="accent-color" src="demos/checkbox-radio-1/" height="240"></iframe>
...
<iframe title="Псевдоэлементы" src="demos/checkbox-radio-2/" height="315"></iframe>
...
<iframe title="Псевдоэлемнеты и дополнительный контейнер" src="demos/checkbox-radio-3/" height="320"></iframe>
...
- Если не используется тэг `<input>`, то для неактивного состояния нужно использовать атрибут [`aria-disabled: true`](a11y/aria-disabled/)
