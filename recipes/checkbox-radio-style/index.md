...
<iframe title="Стилизация чекбокса (accent-color)" src="demos/checkbox-radio-accent-color/" height="300"></iframe>
...
<iframe title="Стилизация чекбокса (псевдоэлемент)" src="demos/checkbox-radio-pseudo-elements/" height="400"></iframe>
...
<iframe title="Стилизация чекбокса (псевдоэлемент и контейнер)" src="demos/checkbox-radio-pseudo-elements-div/" height="370"></iframe>
...
- если чекбокс или радиокнопка находятся в неактивном состоянии `disabled` и одновременно являются отмеченными `:checked`, то нужно использовать атрибут [`aria-disabled: true`](a11y/aria-disabled/), чтобы скринридеры зачитывали этот выбранный чекбокс, а не пропускали его, и пользователи знали, на что они соглашаются по умолчанию или какую настройку нельзя изменить;
- дизайн чекбоксов и радиокнопок должен понятно иллюстрировать неотмеченное и отмеченное состояния.
